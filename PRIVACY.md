...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Japanese legal professional rules.
...
- Japan Federation of Bar Associations (JFBA / Nichibenren, 日本弁護士連合会) rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/japan-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Japan)

### Attorney Act and JFBA Rules

Japanese lawyers (弁護士, bengoshi) are bound by strict confidentiality rules under the Attorney Act (弁護士法) and the JFBA Basic Rules on the Duties of Practicing Attorneys (弁護士職務基本規程).

#### Attorney-Client Confidentiality (守秘義務)

- All attorney-client communications are protected under Article 23 of the Attorney Act
- Professional secrecy (守秘義務) is also protected under the Penal Code (Article 134)
...
### APPI and Client Data Processing

Under the **APPI (Act on Protection of Personal Information, 個人情報保護法)**:

- You are the **Business Operator Handling Personal Information** (個人情報取扱事業者) when processing client personal data
- AI service providers (Anthropic, Vercel) may be **Entrusted Parties** (委託先)
- Cross-border data transfers must comply with APPI Article 28 requirements (consent or adequate safeguards)
- The **Personal Information Protection Commission (PPC, 個人情報保護委員会)** oversees compliance
...
```
Example: "What does the Civil Code say about tort liability?"
```
...
```
Example: "What are the penalties for insider trading under the Financial Instruments and Exchange Act?"
```
...
3. Client matters: Use commercial legal databases (Westlaw Japan, LexisNexis JP, D1-Law)

### For Large Firms / Corporate Legal

1. Negotiate data processing agreements with AI service providers under APPI requirements
...
2. Follow Japanese government information security requirements (NISC guidelines)
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/japan-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **JFBA Guidance**: Consult Japan Federation of Bar Associations (Nichibenren) ethics guidance
