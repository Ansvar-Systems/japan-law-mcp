/**
 * validate_citation — Validate a Japanese legal citation against the database.
 */
...
export async function validateCitationTool(
  ...
  const formattedJa = formatCitation(result.citation, 'japanese');

  return {
    results: {
      citation: input.citation,
      formatted_citation: formatted,
      formatted_citation_ja: formattedJa,
