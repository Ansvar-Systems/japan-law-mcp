...
export type EUCommunity = 'EU' | 'EC' | 'EEC';
export type ReferenceType = 'implements' | 'supplements' | 'applies' | 'references' | 'complies_with' | 'adequacy_decision' | 'cites_article';
...
export interface JPImplementation {
  document_id: string;
  title: string;
  reference_type: ReferenceType;
  is_primary: boolean;
