/**
 * Runtime capability detection for Japan Law MCP.
...
const TABLE_MAP: Record<Capability, string[]> = {
  ...
  english_translations: ['legal_provisions'],
  cabinet_orders: ['cabinet_orders'],
  ministerial_ordinances: ['ministerial_ordinances'],
  ppc_guidelines: ['ppc_guidelines'],
};
