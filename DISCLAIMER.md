...
- **Professional Rules**: Japan Federation of Bar Associations members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (e-Gov Laws (e-gov.go.jp), Japanese Law Translation)
...
This Tool aggregates data from official Japan legal databases. However:
...
- Westlaw Japan, LexisNexis JP, D1-Law
...
- Japan law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (e-Gov Laws (e-gov.go.jp), Japanese Law Translation)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Japan-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Japan-law-mcp/issues
