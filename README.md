...
**Endpoint:** `https://mcp.ansvar.eu/law-jp/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add japan-law --transport http https://mcp.ansvar.eu/law-jp/mcp` |
...
```json
{
  "mcpServers": {
    "japan-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-jp/mcp"
    }
  }
}
```
...
| `get_japanese_implementations` | Find Japanese laws implementing EU act |
