...
const SERVER_NAME = 'japan-law-mcp';
...
const GITHUB_REPO = 'Ansvar-Systems/japan-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.JAPAN_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.JAPAN_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
